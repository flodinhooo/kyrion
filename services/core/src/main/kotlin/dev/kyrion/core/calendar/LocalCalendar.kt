...
class LocalCalendarRepository(private val jdbc: JdbcClient) {
    ...
    private fun validate(body: LocalCalendarEventRequest) { if(body.title.isBlank() || body.title.length > 500 || !body.endsAt.isAfter(body.startsAt)) throw InvalidCalendarEvent() }
...
class InvalidCalendarEvent: RuntimeException()
