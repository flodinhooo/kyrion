...
export const Icons = {
  calendar: (props: IconProps) => <IconBase {...props}><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /></IconBase>,
  ...
  key: (props: IconProps) => <IconBase {...props}><circle cx="8" cy="15" r="3" /><path d="m10.2 12.8 8.3-8.3M15 7l2 2M17 5l2 2" /></IconBase>,
